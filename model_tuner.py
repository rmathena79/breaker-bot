...
class ModelTuner(object):
    ...
    def CreateModel(self, hp) -> tf.keras.Model:
        ...
        if fancy_topo == "NONE":
            ...
            model.add(tf.keras.layers.GRU(processing_units, activation=activation_A, recurrent_activation=recurrent_activation_A))
        elif fancy_topo == "RNN":
            ...
            model.add(tf.keras.layers.LSTM(processing_units, activation=activation_A, recurrent_activation=recurrent_activation_A))
            ...
            model.add(tf.keras.layers.GRU(processing_units, return_sequences=True, activation=activation_A, recurrent_activation=recurrent_activation_A))
            model.add(tf.keras.layers.LSTM(processing_units, activation=activation_B, recurrent_activation=recurrent_activation_B))
